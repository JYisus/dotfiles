...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-------------------------------------------------------------------------.  .-----------------------------------------------------------------------------.
       KC_TAB,    KC_1,    KC_2,    KC_3,    KC_4,          KC_5,      _______,            _______,          KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,
  //|--------+--------+--------+--------+--------+--------------+-------------|  |----------------+--------------+--------+--------+--------+--------+--------|
      KC_LCTL, KC_LSFT, KC_LCTL, KC_LALT, XXXXXXX,       XXXXXXX,      _______,            _______,       KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, XXXXXXX, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------------+-------------'  '----------------+--------------+--------+--------+--------+--------+--------|
