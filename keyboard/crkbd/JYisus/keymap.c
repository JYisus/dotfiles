...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------------+--------+--------+--------+--------+--------------+--------------|  |---------------+--------------+---------------+--------+--------+--------+----------------|
      CTL_T(KC_ESC),    KC_A,    KC_S,    KC_D,    KC_F,          KC_G,       KC_LALT,           KC_RALT,          KC_H,           KC_J,    KC_K,    KC_L, KC_SCLN, RCTL_T(KC_QUOT),
  //|--------------+--------+--------+--------+--------+--------------+--------------'  '---------------+--------------+---------------+--------+--------+--------+----------------|
  ...
  //,--------------------------------------------------------------------------.  .-------------------------------------------------------------------------------.
       KC_GRV, KC_EXLM,   KC_AT, KC_HASH, KC_DLR,        KC_PERC,       _______,           _______,       KC_SLSH,        KC_7,    KC_8,    KC_9, KC_MINS,  KC_EQL,
  //|--------+--------+--------+--------+--------+--------------+--------------|  |---------------+--------------+------------+--------+--------+--------+--------|
      KC_LCTL, KC_AMPR, KC_HASH,  KC_DLR, KC_LPRN,       KC_RPRN,       _______,           _______,       KC_ASTR,        KC_4,    KC_5,    KC_6, KC_PLUS,  KC_GRV,
  //|--------+--------+--------+--------+--------+--------------+--------------'  '---------------+--------------+------------+--------+--------+--------+--------|
      KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, KC_LBRC,       KC_RBRC,                                         KC_PERC,        KC_1,    KC_2,    KC_3, KC_PERC, KC_RSFT,
  //|--------+--------+--------+--------+--------+--------------+--------------.  .---------------+--------------+------------+--------+--------+--------+--------|
                                          KC_LGUI, LT(5, KC_SPC), LT(3, KC_SPC),     LT(3, KC_ENT), LT(5, KC_SPC), RSFT_T(KC_0)
                                      //`--------------------------------------'  `--------------------------------------------'
  ),
